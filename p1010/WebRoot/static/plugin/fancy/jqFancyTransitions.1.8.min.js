...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:550,height:330,strips:10,delay:5000,stripDelay:50,titleOpacity:0.4,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:'',navigation:true,links:true,prevnext:false,numbers:true};})(jQuery);