...
$(function(){
	submitForm('<%=path %>/server/brand!add.action', '#submitForm');
});
</script>
</head>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="/static/skin/server/images/tbg.gif">新增品牌</td>
</tr>
<tr align="left" bgcolor="#FAFAF1">
	<td width="15%">名称:</td>
	<td width="85%"><input type="text" id="name" name="brand.name" style="width:150px;" class="{required:true,rangelength:[2,13]}" />&nbsp;<label class="lb_rq">*</label></td>
</tr>
<tr align="left" bgcolor="#FAFAF1">
