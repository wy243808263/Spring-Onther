...
<script>
	...
	function pageMain(){
		initPage('<%=path %>/server/res!pageTotal.action', '<%=path %>/server/res!page.action', $('#offset').val(), $('#limit').val(), $('#searchForm').serialize());
	}
	function f5(){
		location.href = "<%=path %>/dynamic/server/res/page.jsp";
	}
</script>
</head>
...
<tr align="center" bgcolor="#FAFAF1">
	...
	<td class="theader" width="15%">类型</td>
	<td class="theader" width="15%">名称</td>
	<td class="theader" width="35%">路径</td>
...
<tr align="right" bgcolor="#FFFFFF">
	<td height="36" colspan="5" align="right">
		<!--翻页代码 -->
