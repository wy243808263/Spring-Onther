...
　　			$('.widget .tools .icon-remove').click(function () {
    		...
    		$('#btn_confirm').click(function () {
        		location="${ctx}/returninvoiceController/return_medium.do";
    		});
　　		}); 
   	</script>
				...
				<div class="span12">
					...
					<div class="widget blue">
						<div class="widget-title">
							<h4>
								<i class="icon-reorder"></i> 确认将发票卷退回金税设备
							</h4>
							<span class="tools"> <a href="javascript:;"
								class="icon-remove"></a> </span>
						</div>
						<div class="widget-body" style="height: 100%;">
							<p style="text-align: center;">本次退回发票卷信息如下，请确认是否退回。</p>
							<div>
								...
								<table class="table table-striped table-hover table-bordered"
									...
									<tbody>
										<c:forEach items="${invoiceinventoryVos}" var="item" varStatus="status">
											<tr class="odd gradeX">
												<td></td>
							...
							<div class="box" style="margin-top:10px;">
								...
								<button id="btn_cancel" type="button" class="btn btn-primary" style="border-radius: 4px!important;" onClick="history.go(-1);">取消</button>
							</div>
						</div>
					</div>
