...
<script>
	...
	function pageMain(){
		initPage('<%=path %>/server/user!pageTotal.action', '<%=path %>/server/user!page.action', $('#offset').val(), $('#limit').val(), $('#searchForm').serialize());
	}
	function f5(){
		location.href = "<%=path %>/dynamic/server/user/page.jsp";
	}
</script>
</head>
...
<tr align="center" bgcolor="#FAFAF1">
	...
	<td class="theader" width="10%">账号</td>
	<td class="theader" width="10%">姓名</td>
	<td class="theader" width="10%">收集</td>
	<td class="theader" width="10%">邮箱</td>
	<td class="theader" width="10%">状态</td>
