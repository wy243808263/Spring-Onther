...
<html>
  ...
  <body>
    <div id="main-content">
		<form action="${ctx }/administrativedivisionController/update.do" method="post">
			<input type="hidden" name="id" value="${administrativedivisions.id }" />
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										<td class="text">*编码</td>
										<td colspan="4">
											<input type="text" class="span12" value="${administrativedivisions.code }" name="code" required="">
										</td>
									</tr>
									<tr>
										<td class="text">*名称</td>
										<td colspan="4">
											<input type="text" class="span12" value="${administrativedivisions.name }" name="name" required="" >
										</td>
									</tr>
