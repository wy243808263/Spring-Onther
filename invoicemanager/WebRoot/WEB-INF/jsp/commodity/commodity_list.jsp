...
function showAdd(){
	location="${ctx}/commodityController/toadd.do";
}
function showupdate(){
	...
	if(id!=0){
		if(id.indexOf(",")>0){
			...
			location="${ctx}/commodityController/toedit.do?id="+id;
		}
	}else{
		alert("请选择数据");
	}
...
function delete_list(){
	...
	if(id!=0){
		if(id.indexOf(",")>0){
			if(confirm("是否删除??")){
				window.location.href="${ctx}/commodityController/delitem.do?ids="+id;
			}
		}else{
			if(confirm("是否删除??")){
				window.location.href="${ctx}/commodityController/delete.do?id="+id;
			}
		}
	}else{
		alert("请选择数据");
					...
					<div class="navbar-inner">
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">商品税目</th>
                                <th class="hidden-phone">税率</th>
                                <th class="hidden-phone">规格型号</th>
                                <th class="hidden-phone">计量单位</th>
                                <th class="hidden-phone">含税价标志</th>
                                <th class="hidden-phone">隐藏标志</th>
