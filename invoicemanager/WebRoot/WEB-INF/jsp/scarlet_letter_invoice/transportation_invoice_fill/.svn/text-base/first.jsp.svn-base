...
　　			$('.widget .tools .icon-remove').click(function () {
    		...
    		$('#btn_confirm').click(function () {
        		location="${ctx}/transportationfillController/fill.do";
    		});
　　		}); 
   	</script>
  </head>
    			...
    			<div class="span12">
    				<div class="widget blue">
						...
						<div class="widget-body">
							<div class="Groudbox">
								<label style="position: absolute;margin-top: -25px;">开具红字货物运输业增值税专用发票信息表信息选择</label>
								<ul>
									<li>
										<label class="radio"><input type="radio" name="gender" value="1">一、实际受票方申请</label>
										<ul>
											<li>
												<label class="radio"><input type="radio" name="gender1" value="male">1、已抵扣</label>
											</li>
											<li>
												<label class="radio"><input type="radio" name="gender1" value="male">2、未抵扣</label>
												<ul>
													<li>
														<label class="radio"><input type="radio" name="gender2" value="male">(1)、无法认证</label>
													</li>
													<li>
														<label class="radio"><input type="radio" name="gender2" value="male">(2)、纳税人识别号认证不符</label>
													</li>
													<li>
														<label class="radio"><input type="radio" name="gender2" value="male">(3)、增值税专用发票代码、号码认证不符</label>
													</li>
													<li>
														<label class="radio"><input type="radio" name="gender2" value="male">(4)、所购服务不属于增值税扣税项目范围</label>
													</li>
												</ul></li>
										</ul></li>
									<li>
										<label class="radio"><input type="radio" name="gender" value="2">一、承运人申请</label>
										<ul>
											<li>
												<label class="radio"><input type="radio" name="gender1" value="male">1、因开票有误受票方拒收的</label>
											</li>
											<li>
												<label class="radio"><input type="radio" name="gender1" value="male">2、因开票有误等原因尚未交付的</label>
											</li>
										</ul>
									</li>
								</ul>
							...
							<div class="Groudbox">
							<label style="position: absolute;margin-top: -25px;">对应蓝字货物运输业增值税专用发票信息</label>
