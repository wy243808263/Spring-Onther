...
<html>
  ...
  <body>
    <div id="main-content">
		<form action="${ctx }/vehicleController/add.do" method="post">
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" class="span12" value="" name="vehicletype" required="" >
										</td>
										<td class="text">*编码</td>
										<td>
									...
									<tr>
										...
										<td>
											<input type="text" class="span12" value="" name="brandmodel">
										</td>
										<td class="text">简码</td>
										<td>
										...
										<td class="text">产地</td>
										<td>
											<input type="text" class="span12" value="" name="originplace" >
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="text" class="span12" value="" name="enterprisename" >
										</td>
