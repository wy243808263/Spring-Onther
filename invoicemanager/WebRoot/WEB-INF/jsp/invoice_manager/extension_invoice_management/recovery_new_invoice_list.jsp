				...
				<div class="span12">
					...
					<div class="widget blue">
						<div class="widget-title">
							<h4>
								<i class="icon-reorder"></i> 收回分机新购发票
							</h4>
							<span class="tools"> <a href="javascript:;"
								class="icon-remove"></a> </span>
						</div>
						<div class="widget-body" style="height: 100%;">
							<p style="text-align: center;">成功从分机收回下列新购发票:</p>
							<div>
									...
									<tbody>
										<c:forEach items="${extensiokuVos}" var="item" varStatus="status">
											<tr class="odd gradeX">
												...
												<td>2017-03-04</td>
												<%-- <fmt:formatDate value="${item.linggoudate}" type="both" pattern="yyyy-MM-dd" /> --%>
											</tr>
										</c:forEach>
									</tbody>
								</table>
