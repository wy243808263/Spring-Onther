...
function showAdd(){
	location="${ctx}/receiveController/toadd.do";
}
function showupdate(id){
	...
	if(id!=0){
		if(id.indexOf(",")>0){
			...
			location="${ctx}/receiveController/toedit.do?id="+id;
		}
	}else{
		alert("请选择数据");
	}
...
function delete_list(id){
	...
	if(id!=0){
		if(id.indexOf(",")>0){
			if(confirm("是否删除??")){
				window.location.href="${ctx}/receiveController/delitem.do?ids="+id;
			}
		}else{
			if(confirm("是否删除??")){
				window.location.href="${ctx}/receiveController/delete.do?id="+id;
			}
		}
	}else{
		alert("请选择数据");
                ...
                <div class="widget blue">
					...
					<div class="navbar-inner">
						<div class="container">
							...
							<div class="nav-collapse">
								...
								<ul class="nav pull-right">
									...
									<li><a onclick="showupdate(id)">修改</a></li>
									<li><a onclick="delete_list(id)">删除</a></li>
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
									<c:forEach items="${receives}" var="item" varStatus="status">
										<tr class="odd gradeX">
