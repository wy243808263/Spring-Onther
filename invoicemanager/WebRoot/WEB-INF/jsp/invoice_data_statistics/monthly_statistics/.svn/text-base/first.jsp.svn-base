...
　　			$('.widget .tools .icon-remove').click(function () {
    		...
    		$('#btn_confirm').click(function () {
    			location="${ctx}/monthlycountController/list.do";
    		});
				...
				<div class="widget blue">
					...
					<div class="widget-body">
						...
						<div id="right">
							...
							<label style="color:#910C0C;margin-left:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、汇总范围可选择金税设备使用以来的<br>任意年月。</label>
							<div class="Groupbox" style="border: 1px solid #ccc;border-radius: 4px!important;padding: 15px;width: 50%;">
								...
								<div class="control-group">
									<label class="control-label" style="float: left;">选择年份&nbsp;&nbsp;&nbsp;&nbsp;</label>
									<div class="controls">
										<select id="sel"   style="padding: 5px;"></select>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" style="float: left;">选择月份&nbsp;&nbsp;&nbsp;&nbsp;</label>
									<div class="controls">
										<select id="month" style="padding: 5px;"></select>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" style="float: left;">所属税期&nbsp;&nbsp;&nbsp;&nbsp;</label>
									<div class="controls">
										<select  style="padding: 5px;">
											<c:forEach items="${invoicetypes}" var="item">
												<option value="${item.id}">${item.classname}</option>
