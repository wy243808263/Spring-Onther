...
function showAdd(){
	location="${ctx}/vehicleController/toadd.do";
}
function showupdate(id){
	...
	if(id!=0){
		if(id.indexOf(",")>0){
			...
			location="${ctx}/vehicleController/toedit.do?id="+id;
		}
	}else{
		alert("请选择数据");
	}
...
function delete_list(id){
	...
	if(id!=0){
		if(id.indexOf(",")>0){
			if(confirm("是否删除??")){
				window.location.href="${ctx}/vehicleController/delitem.do?ids="+id;
			}
		}else{
			if(confirm("是否删除??")){
				window.location.href="${ctx}/vehicleController/delete.do?id="+id;
			}
		}
	}else{
		alert("请选择数据");
					...
					<div class="navbar-inner">
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th>编码</th>
                                <th class="hidden-phone">车辆类型</th>
                                <th class="hidden-phone">简码</th>
                                <th class="hidden-phone">厂牌型号</th>
                                <th class="hidden-phone">产地</th>
                                <th class="hidden-phone">生产企业名称</th>
