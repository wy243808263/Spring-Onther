...
<script>
	...
	function pageMain(){
		initPage('<%=path %>/server/goods!pageTotal.action', '<%=path %>/server/goods!page.action', $('#offset').val(), $('#limit').val(), $('#searchForm').serialize());
	}
	function f5(){
		location.href = "<%=path %>/dynamic/server/goods/page.jsp";
	}
</script>
</head>
...
<tr align="center" bgcolor="#FAFAF1">
	...
	<td class="theader" width="10%">品牌</td>
	<td class="theader" width="10%">分类</td>
	<td class="theader" width="10%">名称</td>
	<td class="theader" width="10%">库存</td>
