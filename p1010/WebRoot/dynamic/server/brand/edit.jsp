...
$(function(){
	submitForm('<%=path %>/server/brand!edit.action', '#submitForm');
});
</script>
</head>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="/static/skin/server/images/tbg.gif">修改品牌资料</td>
</tr>
<tr align="left" bgcolor="#FAFAF1">
	<td width="15%">品牌名称:</td>
	<td width="85%"><input type="text" style="width:150px;" name="brand.name" value="${brand.name}" class="{required:true,rangelength:[2,13]}" />&nbsp;<label class="lb_rq">*</label></td>
</tr>
<tr align="left" bgcolor="#FAFAF1">
