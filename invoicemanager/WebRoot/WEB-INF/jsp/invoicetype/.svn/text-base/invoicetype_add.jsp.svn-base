...
#main-content {
  ...
  <body>
    <div id="main-content">
		<form action="${ctx }/invoicetypeController/add.do" method="post">
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" class="span12" value="" name="classname" required="" >
										</td>
										<td class="text">*发票种类编码</td>
										<td>
											<input type="text" class="span12" value="" name="classcode" required="" >
										</td>
									</tr>
								</tbody>
							</table>
