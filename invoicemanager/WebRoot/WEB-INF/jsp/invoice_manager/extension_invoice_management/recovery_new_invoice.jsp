...
　　			$('.widget .tools .icon-remove').click(function () {
    		...
    		$('#btn_confirm').click(function () {
    			var ids = $('input[name="gender"]:checked ').val();
    			var types = $('input[name="gender1"]:checked ').val();
        		location="${ctx}/extensioninvoiceController/new_list.do?medium="+ids+"&"+"type="+types;
    		});
					...
					<div class="widget-body" style="height: 70%;">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">请选择新购发票的分机介质</h3>
							</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">请选择新购发票的发票类型</h3>
							</div>
							<div class="panel-body">
								<div class="box" style="margin-left: 50px;">
									<label class="radio"><input type="radio" name="gender1" value="1" checked="checked">增值税专用发票、普通发票</label> 
									<label class="radio"><input type="radio" name="gender1" value="2">机动车销售统一发票、电子增值税普通发票及增值税普通发票（卷票）</label> 
									<label class="radio"><input type="radio" name="gender1" value="3">货物运输业增值税专用发票</label>
								</div>
							</div>
						</div>
