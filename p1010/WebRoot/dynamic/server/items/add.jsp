...
$(function(){
	loadBrand();
	submitForm('<%=path %>/server/items!add.action', '#submitForm');
});
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="/static/skin/server/images/tbg.gif">新增分类</td>
</tr>
<tr align="left" bgcolor="#FAFAF1">
	<td width="15%">品牌:</td>
	<td width="85%">
	<select name="items.brand.id" id="brand" class="{required:true}">
...
<tr align="left" bgcolor="#FAFAF1">
	<td width="15%">名称:</td>
	<td width="85%"><input type="text" id="name" name="items.name" style="width:150px;" class="{required:true,rangelength:[2,20]}" />&nbsp;<label class="lb_rq">*</label></td>
</tr>
<tr align="left" bgcolor="#FAFAF1">
